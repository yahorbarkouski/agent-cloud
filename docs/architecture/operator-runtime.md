...
Customer destroy supplies the provisioning cancellation path. The first live customer drill still requires explicit operator resolution of unsettled effects, a renewal-capable retained release, owned customer firewall setup and a bounded lifecycle/cleanup exercise. No live customer VM is claimed from the protocol fixture.
